        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFixedDate = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_AvailabilityInterval_Time", "\"StartTime\" < \"EndTime\"");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AvailabilityIntervals_Participants_ParticipantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailabilityIntervals_ParticipantId",
                table: "AvailabilityIntervals",
                column: "ParticipantId");

            migrationBuilder.CreateIndex(
                name: "IX_Events_OwnerCode",
                table: "Events",
                column: "OwnerCode",
                unique: true);
